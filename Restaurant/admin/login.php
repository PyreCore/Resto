...
/* Déconnexion : on détruit la session, puis on retourne vers la page indiquée (site client par défaut) */
if (isset($_GET['deconnexion'])) {
    session_destroy();
    $retour = isset($_GET['retour']) ? $_GET['retour'] : 'login.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_SESSION['login_bloque_jusqua']) && $maintenant < $_SESSION['login_bloque_jusqua']) {
        ...
        if (hash_equals(ADMIN_MOT_DE_PASSE, $saisie)) {
